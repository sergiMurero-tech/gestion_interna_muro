...
const SECCIONES = [
  {
    label: 'Historia',
    desc: 'Cómo nació y evolucionó el Muro CF.',
    to: '/club/historia',
    icon: (
  ...
  {
    label: 'Directiva',
    desc: 'Las personas detrás del club.',
    to: '/club/directiva',
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    ...
    desc: 'Quienes hacen posible el club.',
...
export default function ClubIndexPage() {
  return (
    <div className="mx-auto max-w-6xl px-4 py-12">
      <span className="eyebrow">Nuestro club</span>
