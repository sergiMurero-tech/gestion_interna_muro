...
export default function NoticiaDetailPage() {
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-8">
      ...
      <span className="mb-2 block text-sm text-zinc-400">{formatFecha(noticia.fecha_publicacion)}</span>
      <h1 className="mb-6 text-3xl font-extrabold text-white">{noticia.titulo}</h1>
      ...
      {noticia.adjuntos?.length > 0 && (
        <div className="mt-8">
          <h2 className="mb-4 text-xl font-bold text-white">Adjuntos</h2>
